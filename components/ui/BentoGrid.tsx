...
import BorderMagic from "./BorderMagic";
...
export const BentoGridItem = ({
  ...
  const leftLists = ["ReactJS", "ReactNative", "Javascript"];
  const rightLists = ["Tailwindcss", "NextJs", "Html5"];
  ...
  const handleCopy = () => {
    const text = "yomidaniels11@gmail.com";
